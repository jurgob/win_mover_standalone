...
set position of _window to {_left, _top}
set size of _window to {_width, _height}

end tell

-- tell first window of application (path to frontmost application as Unicode text) to set bounds to {0, 0, 1280, 1080}
